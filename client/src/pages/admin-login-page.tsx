...
/**
 * The admin dashboard sign-in.
 *
 * PIN and password only. Discord is not a way into the dashboard — it is an
 * integration an already-signed-in administrator can connect from the
 * Integrations page, which is what lets the bot report their role.
 */
